    ...
    <div className="px-6">
      <div className="flex flex-col md:flex-row items-start justify-between w-full">
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="flex">
            <div className="cursor-pointer flex gap-4 text-xl border-2 border-gray-300 w-24 justify-center rounded-md m-3">
              <span onClick={() => setVal(Math.max(1, val - 1))}>-</span>
              <span>{val}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          <div className="mb-6">
            <div className="font-bold border-2 h-12 py-2 px-2 border-gray-200 flex justify-between">
              <span>livraisonsTitle</span>
              <span>+</span>
            </div>
          </div>
          <div className="mb-6">
            <div className="font-bold border-2 h-12 py-2 px-2 border-gray-200 flex justify-between">
              <span>questionsTitle</span>
              <span>+</span>
            </div>
          </div>
        </div>
